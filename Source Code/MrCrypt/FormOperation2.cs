/***  MrCrypt         ***/
/***  Desencriptador - English Version  ***/
...
namespace MrCrypt
{
    public partial class FormOperation2 : Form
    {
        BackgroundWorker elWorker;
        byte[] matriz;
        uint card;

        public FormOperation2()
        {
            InitializeComponent();
        ...
        private void elWorker_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            {
                labelBytes.Text = card + " Decrypted Bytes";

                if (MessageBox.Show("*** File Properly Decrypted ***\nDo you want to open the location of the Decrypted file?",
        ...
        private void elWorker_ProgressChanged(object sender, ProgressChangedEventArgs e)
        {
            ...
            imgFiles2.Visible = true;
            progressBar.Value = e.ProgressPercentage;
            if (progressBar.Value == 75) { labelBytes.Text = "Decrypting File..."; }
        }
